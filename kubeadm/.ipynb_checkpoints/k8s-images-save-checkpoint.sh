...
docker save k8s.gcr.io/etcd:3.3.15-0 -o $IMAGES_PATH/A6-k8s-etcd-3.3.15-0.tar
echo ""

echo "A7.>> k8s.gcr.io/coredns:1.6.2"
docker save k8s.gcr.io/coredns:1.6.2 -o $IMAGES_PATH/A7-k8s-coredns-1.6.2.tar
echo ""
