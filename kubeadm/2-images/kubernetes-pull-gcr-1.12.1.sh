echo ""
echo "=========================================================="
echo "Pull Kubernetes 1.12.1 Images from k8s.gcr.io ......"
echo "You may need proxy, using as: "
echo "https_proxy=192.168.199.99:9999 ./get-kubeimages-1.12.1.sh"
echo "=========================================================="
echo ""
...
echo ""
echo "5.k8s-etcd"
docker pull k8s.gcr.io/etcd:3.2.28
...
echo ""
echo "=========================================================="
echo "Pull Kubernetes 1.12.1 Images from k8s.gcr.io, FINISH."
echo "=========================================================="
echo ""
