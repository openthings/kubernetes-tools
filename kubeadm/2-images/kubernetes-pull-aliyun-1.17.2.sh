...
## 添加Tag
docker tag ${MY_REGISTRY}/k8s-gcr-io-kube-apiserver:v1.17.1 k8s.gcr.io/kube-apiserver:v1.17.2
docker tag ${MY_REGISTRY}/k8s-gcr-io-kube-scheduler:v1.17.1 k8s.gcr.io/kube-scheduler:v1.17.2
docker tag ${MY_REGISTRY}/k8s-gcr-io-kube-controller-manager:v1.17.1 k8s.gcr.io/kube-controller-manager:v1.17.2
docker tag ${MY_REGISTRY}/k8s-gcr-io-kube-proxy:v1.17.1 k8s.gcr.io/kube-proxy:v1.17.2
