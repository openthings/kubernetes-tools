echo ""
echo "=========================================================="
echo "Push Kubernetes v1.17.2 Images into aliyuncs.com ......"
echo "=========================================================="
echo ""
...
docker push ${MY_REGISTRY}/k8s-gcr-io-kube-apiserver:v1.17.2

echo ""
echo "2.k8s-kube-controller-manager"
docker push ${MY_REGISTRY}/k8s-gcr-io-kube-controller-manager:v1.17.2

echo ""
echo "3.k8s-kube-scheduler"
docker push ${MY_REGISTRY}/k8s-gcr-io-kube-scheduler:v1.17.2

echo ""
echo "4.k8s-kube-proxy"
docker push ${MY_REGISTRY}/k8s-gcr-io-kube-proxy:v1.17.2
...
echo ""
echo "=========================================================="
echo "Push Kubernetes v1.17.2 Images FINISHED."
