echo ""
echo "=========================================================="
echo "Pull Kubernetes v1.17.4 Images from k8s.gcr.io ......"
...
docker pull k8s.gcr.io/kube-apiserver:v1.17.4

echo ""
echo "2.k8s-kube-controller-manager"
docker pull k8s.gcr.io/kube-controller-manager:v1.17.4

echo ""
echo "3.k8s-kube-scheduler"
docker pull k8s.gcr.io/kube-scheduler:v1.17.4
...
echo ""
echo "=========================================================="
echo "Pull Kubernetes v1.17.4 Images from k8s.gcr.io, FINISH."
echo "=========================================================="
echo ""
