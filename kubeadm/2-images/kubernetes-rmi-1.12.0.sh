...
docker rmi k8s.gcr.io/kube-apiserver:v1.12.0

echo ""
echo "2.k8s-kube-controller-manager"
docker rmi k8s.gcr.io/kube-controller-manager:v1.12.0

echo ""
echo "3.k8s-kube-scheduler"
docker rmi k8s.gcr.io/kube-scheduler:v1.12.0

echo ""
echo "4.k8s-kube-proxy"
docker rmi k8s.gcr.io/kube-proxy:v1.12.0
