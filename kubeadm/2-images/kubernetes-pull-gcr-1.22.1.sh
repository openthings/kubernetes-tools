echo ""
echo "=========================================================="
echo "Pull Kubernetes v1.22.1 Images from k8s.gcr.io ......"
...
docker pull k8s.gcr.io/kube-apiserver:v1.22.1

echo ""
echo "2.k8s-kube-controller-manager"
docker pull k8s.gcr.io/kube-controller-manager:v1.22.1

echo ""
echo "3.k8s-kube-scheduler"
docker pull k8s.gcr.io/kube-scheduler:v1.22.1

echo ""
echo "4.k8s-kube-proxy"
docker pull k8s.gcr.io/kube-proxy:v1.22.1
...
echo ""
echo "=========================================================="
echo "Pull Kubernetes v1.22.1 Images from k8s.gcr.io, FINISH."
echo "=========================================================="
echo ""
