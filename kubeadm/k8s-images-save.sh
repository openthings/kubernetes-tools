...
sudo docker save k8s.gcr.io/kube-apiserver:v1.12.2 -o A1-k8s-kube-apiserver-v1.12.2.tar
echo ""

echo "A2.>> k8s.gcr.io/kube-controller-manager:v1.12.2"
sudo docker save k8s.gcr.io/kube-controller-manager:v1.12.2 -o A2-k8s-kube-controller-manager-v1.12.2.tar
echo ""

echo "A3.>> k8s.gcr.io/kube-scheduler:v1.12.2"
sudo docker save k8s.gcr.io/kube-scheduler:v1.12.2 -o A3-k8s-kube-scheduler-v1.12.2.tar
echo ""

echo "A4.>> k8s.gcr.io/kube-proxy:v1.12.2"
sudo docker save k8s.gcr.io/kube-proxy:v1.12.2 -o A4-k8s-kube-proxy-v1.12.2.tar
echo ""
