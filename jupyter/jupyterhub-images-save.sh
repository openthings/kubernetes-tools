...
docker save quay.io/kubernetes-ingress-controller/nginx-ingress-controller:0.21.0 -o ${images_path}A3-quay.io-kubernetes-ingress-controller-nginx-ingress-controller-0.21.0.tar
echo ""

echo "A4.>> jetstack/kube-lego:canary"
docker save jetstack/kube-lego:canary -o ${images_path}A4-jetstack-kube-lego-canary.tar
echo ""
...
docker save jupyterhub/k8s-singleuser-sample:cc865bd -o ${images_path}A6-jupyterhub-k8s-singleuser-sample-cc865bd.tar
echo ""
